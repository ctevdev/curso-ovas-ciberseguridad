OVA U3-01 - Senales de alerta, registros basicos y monitoreo de cuentas
=======================================================================

Objetivo
--------
Reconocer senales de alerta, revisar registros basicos de actividad y
aplicar habitos de monitoreo en cuentas, dispositivos y servicios digitales
para detectar posibles incidentes de forma temprana.
...
----------------------------
1. Entrar dentro de la carpeta ova-u3-01-senales-alerta-monitoreo-cuentas.
...
8. Activar seguimiento de finalizacion cuando el SCORM reporte estado
...
Notas de privacidad
-------------------
La OVA no solicita ni almacena contrasenas reales, codigos de verificacion,
datos bancarios, documentos de identidad, telefonos reales, direcciones,
correos personales obligatorios ni capturas reales.

Recursos
--------
El archivo MATERIAL_AYUDA_U3_OVA1.txt se incluye como material de apoyo dentro
