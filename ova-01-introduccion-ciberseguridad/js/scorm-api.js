(function (global) {
  ...
  function findApi(win) {
    ...
    } catch (error) { /* El navegador puede impedir acceso a opener. */ }
    return null;
  }
  ...
  function saveSuspendData(data) {
    return setValue("cmi.suspend_data", JSON.stringify(data));
  }
  ...
  function loadSuspendData() {
    ...
    try { return JSON.parse(raw); }
      ...
      console.warn("No fue posible interpretar cmi.suspend_data.", error);
      return null;
    }
  }
